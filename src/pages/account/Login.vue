<template>
  <div id="Login">
    ...
    <div class="login-frame">
      ...
      <div class="tl-cf">
        <div class="tl-fl register-text"><router-link class="tl-yellow" to="/account/register">立即注册</router-link></div>
...
<script>
  ...
  export default {
    ...
    methods: {
      async onLoginClick(){
        let res = await Request.accountLogin(this.username,this.password);
        console.log(res);
      }
    }
